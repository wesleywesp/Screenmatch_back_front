...
public class Episodios {
    ...
    public Episodios(Integer numeroTemporada, DadosEpisodios dadosEpisodio) {
        ...
        this.numeroEpisodio = dadosEpisodio.episodioNumero();
    ...
    public void setNumeroEpisodio(Integer episodioNumero) {
        this.numeroEpisodio = episodioNumero;
    }
